...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/vanshatajaiswal4/MLOPS.mlflow",
    "dagshub_repo_owner": "vanshatajaiswal4",
...
try:
    ...
    dagshub = None
    print(f"dagshub is not available; skipping DagsHub integration: {e}")
